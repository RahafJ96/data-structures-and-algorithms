...
the 3rd power (hint: look up Math.pow()). Use forEach to solve this 
problem.
...
Write a function named addQuestion that, given an array of strings, uses map to return a new array containing each string 
